<template>
  <div class="mb-8 d-flex align-center">
    ...
    <h2 class="">Propiedad <span class="font-weight-light">/ {{ formatModelId(property?.id, 'PRO') }}</span></h2>
  </div>
  <div>
    ...
    <v-window v-model="tab">
      ...
      <v-window-item value="attachments">
        <AttachmentManager v-if="property" :attachable-type="'property'" :attachable-id="property.id" />
      </v-window-item>
