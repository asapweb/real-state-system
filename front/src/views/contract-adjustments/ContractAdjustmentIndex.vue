<template>
  <div class="mb-8">
      ...
      <p class="text-medium-emphasis mt-1" >
        Permite controlar los ajustes pactados en contratos, <br> agregando valor a los que aún no lo tienen (como los de tipo índice) y asegurando su impacto en las cobranzas.
      </p>
    </div>
